    ...
    <>
      ...
      <main>
        <div className="grid h-screen place-items-center">
          <div className="bg-slate-700 rounded w-1/2 text-white">
            ...
            <div className="space-x-4 ml-4 mt-4">
              ...
              <div className="place-items-center grid">
                <button on className="uppercase place-items-center grid block w-5/6 tracking-wide font-bold bg-orange-500 rounded-3xl text-white p-3 mt-4">Submit</button>
              </div>
          </div>
        </div>
      </main>
